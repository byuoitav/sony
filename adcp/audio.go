...
func (p *Projector) Volumes(ctx context.Context, blocks []string) (map[string]int, error) {
...
func (p *Projector) Mutes(ctx context.Context, blocks []string) (map[string]bool, error) {
